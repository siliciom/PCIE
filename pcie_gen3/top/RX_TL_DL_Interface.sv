interface RX_TL_DL_Interface (
    ...
    RESETn
     ...
     logic [ 7:0][ 7:0] ep_fc_ph;
     logic [ 7:0][ 7:0] ep_fc_nph;
     logic [ 7:0][ 7:0] ep_fc_cmplh;
     logic [ 7:0][11:0] ep_fc_pd;
     logic [ 7:0][11:0] ep_fc_npd;
     logic [ 7:0][11:0] ep_fc_cmpld;
