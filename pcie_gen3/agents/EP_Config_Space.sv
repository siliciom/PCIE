...
class PCIe_Cfg_Space_Model extends uvm_object;
     ...
     extern function void configure_bar(int bar_num, bit is_io, bit is_64bit, bit [31:0] size_mask,
                                        bit used = 1);
...
function bit [31:0] PCIe_Cfg_Space_Model::apply_be(bit [31:0] old_data, bit [31:0] new_data,
                                                   bit [3:0] be);
     apply_be = old_data;
