...
class reg_classcode_revid extends uvm_reg;
     ...
     virtual function void build();
          ...
          base_class.configure(this, 8, 24, "RO", 0, 8'h02, 1, 0,
                               1);  // matches cfg_model (Network ctrlr = 0x02)
     endfunction
endclass
...
class reg_bar extends uvm_reg;
     ...
     virtual function void build();
          ...
          bar_type.configure(this, 2, 1, "RO", 0, 2'b00, 1, 0,
                             1);  // default 32-bit; overridden per-instance below

          prefetchable = uvm_reg_field::type_id::create("prefetchable");
          prefetchable.configure(this, 1, 3, "RO", 0, 1'h0, 1, 0,
                                 1);  // cfg_model never sets this bit
...
class reg_interrupt extends uvm_reg;
     ...
     virtual function void build();
          ...
          interrupt_line.configure(this, 8, 0, "RW", 0, 8'h00, 1, 0,
                                   1);  // cfg_mem[DW_INT_LINE_PIN][7:0] = 0x00
...
class pcie_type0_cfg_reg_block extends uvm_reg_block;
     ...
     virtual function void build();
          ...
          classcode_revid.configure(this);
          classcode_revid.build();

          bist_hdr = reg_bist_hdr_lat_cache::type_id::create("bist_hdr");
          bist_hdr.configure(this);
          bist_hdr.build();
