...
class pcie_type1_cfg_reg_block extends uvm_reg_block;
  ...
  virtual function void build();
    ...
    class_rev.configure(this);          class_rev.build();
    bist_hdr_lat_cls.configure(this);   bist_hdr_lat_cls.build();
    bar0.configure(this);               bar0.build();
    bar1.configure(this);               bar1.build();
    bus_numbers.configure(this);        bus_numbers.build();
    io_base_limit.configure(this);      io_base_limit.build();
    mem_base_limit.configure(this);     mem_base_limit.build();
    pf_mem_base_limit.configure(this);  pf_mem_base_limit.build();
    pf_base_upper32.configure(this);    pf_base_upper32.build();
    pf_limit_upper32.configure(this);   pf_limit_upper32.build();
    io_upper16.configure(this);         io_upper16.build();
    cap_ptr.configure(this);            cap_ptr.build();
    exp_rom.configure(this);            exp_rom.build();
    bridge_ctrl_int.configure(this);    bridge_ctrl_int.build();
